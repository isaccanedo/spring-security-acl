...
import com.isaccanedo.acl.persistence.dao.NoticeMessageRepository;
import com.isaccanedo.acl.persistence.entity.NoticeMessage;
...
public class SpringACLIntegrationTest extends AbstractJUnit4SpringContextTests{
    ...
    @Configuration
    @ComponentScan("com.isaccanedo.acl.*")
